...
object DataBindingComponent {
    ...
    /**
     * coil加载到屏幕上的速度比glide慢。没办法，又捡回来l
     */
    @BindingAdapter(
        value = ["imageUrl", "placeHolder", "error", "useCache", "isCircle"],
        requireAll = false
    )
    @JvmStatic
    fun glideImage(
    ...
    @JvmStatic
    fun CardView.setCardBackground(color: String) {
        setCardBackgroundColor(Color.parseColor(color))
    }

    @BindingAdapter("cardBgColor")
    @JvmStatic
    fun CardView.setCardBackground(@ColorRes color: Int) {
